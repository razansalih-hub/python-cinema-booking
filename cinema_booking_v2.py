#This is an advanced v of cinema booking project
# -- CINEMA BOOKING -- 
...
see = input("Do you want to see this week movies? (yes/ no) ").strip().lower()
bookings = []
if see == "yes" :
    while True:
        ...
        if day in movies_by_day :
            ...
            for movie in movies_by_day[day] :
                ...
                counter += 1
            choice = int(input("Choose a movie pleas (1-3) :"))
            if choice == 1:
            ...
            final_price = movies_details[chosen_film]['Price']
            membership = input("Are you a member of the cinema? (yes/ no) ").strip().lower()
            if membership == "yes" :
                final_price = final_price * 0.9
                print("You have a Discount of 10%!")
                print(f"Your Current Price is: ${final_price:.2f}")
            else :
                print("No Discount.")
            ...
            if confirm == "yes":
                ...
                print("=" *40)
                print("This is your ticket details: ".center(40))
                print(f"Movie : {chosen_film}")
                print(f"Type : {movies_details[chosen_film]['Type']}.")
                print(f"Showtime : {showtimes[chosen_film]}.")
                print(f"Day : {day}.")
                print(f"Origanal price : ${movies_details[chosen_film]['Price']}.")
                print(f"Price after the discount: ${final_price:.2f}")
                print("=" *40)
            ...
            if ticket2 == "no" :
                    number = 1
                    print("\nOk,Thank you for chosing Razan Cinema!")
                    
                    if len(bookings) > 0 :
                        print(f"You have {len(bookings)} booking :")
                        ...
                        print("You didn't book for any movie.")
                    break
            
        else :
            print("Invalid day, pleas try again.")
